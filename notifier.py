...
class VaccinationSlotNotifier:
    def __init__(self, algorithmia_api_key, district_id):
        self.algorithmia_api_key = algorithmia_api_key
    ...
    def launch_notifier(self, recipients_file_path):
